      ...
      <div className="p-4">
        ...
        <div className="flex items-start justify-between gap-3 mb-3">
          <div className="flex-1 min-w-0">
            ...
            <p className="text-sm font-semibold text-[#1B2E4B]">{order.client_name || 'Unknown Client'}</p>
            <p className="text-xs text-[#9CA3AF]">{order.client_email}</p>
          </div>
        ...
        <div className="space-y-2 mb-3">
          <div className="flex items-center gap-2">
            <span className="px-2 py-1 bg-[#F5F0E8] rounded text-xs font-semibold text-[#1B2E4B]">
              {order.subject_field}
            </span>
            <span className="px-2 py-1 bg-[#F5F0E8] rounded text-xs font-semibold text-[#6B7280]">
          ...
          <div className="flex items-center justify-between text-xs">
            ...
            <p className="text-sm font-bold text-[#1B2E4B]">£{order.total_amount.toFixed(2)}</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2 pt-3 border-t border-[#E8E2D9]">
          ...
          <select
            ...
            disabled={updating}
            className="flex-1 px-3 py-1.5 border border-[#E8E2D9] rounded-lg text-xs font-semibold bg-white focus:outline-none focus:ring-2 focus:ring-[#E8A020]/40 disabled:opacity-50"
          >
          ...
          <Link
            ...
            className="px-3 py-1.5 bg-[#1B2E4B] hover:bg-[#16253d] text-white text-xs font-semibold rounded-lg transition-colors"
          >
            Details
          </Link>
        </div>
